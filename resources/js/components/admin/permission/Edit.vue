  ...
  <div>
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>
          <router-link :to="{ name: 'permission_list' }" class="btn btn-primary"
...
export default {
  ...
  methods: {
    ...
    getEditPermission(){
       this.$Progress.start() ;
       axios.get('/api/get/edit/permission/item/'+this.$route.params.id)
       .then(resp => {
           this.form.name=resp.data.permission.name ;
           this.form.guard_name=resp.data.permission.guard_name ;
    ...
    updatePermission() {
       this.$Progress.start()
      this.form
        .post("/api/edit/permission/"+this.$route.params.id, {
