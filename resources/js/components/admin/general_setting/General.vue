                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input
                          ...
                          v-model="form.title"
                        />
                        <has-error :form="form" field="header_contact_number">
                        </has-error>
                      </div>
                      <br />
...
export default {
  ...
  data() {
    return {
      ...
      preview_logo: this.$store.state.storage + "images/no_image.jpg",
      preview_icon: this.$store.state.storage + "images/no_image.jpg",
    };
  },

  methods: {
    getGeneralSetting() {
      axios.get("/api/get/site/info").then((resp) => {
        console.log(resp);
    ...
    uploadLogo(e) {
      ...
      reader.onload = (evt) => {
        ...
        img.onload = () => {
          ...
          if (img.width == this.logo_width && img.height == this.logo_height) {
    ...
    uploadIcon(e) {
      ...
      reader.onload = (evt) => {
        ...
        img.onload = () => {
          console.log(img.width, img.height);
          if (img.width == this.icon_width && img.height == this.icon_height) {
